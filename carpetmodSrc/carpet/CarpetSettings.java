...
public class CarpetSettings
{
    ...
    public static final String carpetVersion = "Carpet Voided Addition " + tagVersion;
...
//    }
    ...
    public static boolean chatTweaks = false;

    @Rule(desc = "Sets custom whitelist disconnect message defined in whitelist_message.txt file", category = {VOIDED, FEATURE})
    public static boolean customWhitelistMessage = false;
    //Bjoel2 end
    ...
    public static enum RuleCategory {
        TNT, FIX, SURVIVAL, CREATIVE, EXPERIMENTAL, OPTIMIZATIONS, FEATURE, COMMANDS, VOIDED, SHADOW
    }
